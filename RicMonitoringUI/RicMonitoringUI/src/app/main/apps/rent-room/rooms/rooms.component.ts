...
export class RoomsComponent implements OnInit {
  ...
  displayedColumns = ['id','name','frequency','price'];
  ...
  ngOnInit(): void {
    ...
    this.dataSource = new FilesDataSource(this._roomsService, this.paginator, this.sort);
...
export class FilesDataSource extends DataSource<any> 
{
    ...
    private _sort: MatSort)
  {
    ...
    this.filteredData = this._roomsService.rooms;
  ...
  connect(): Observable<any[]>
  {
    const displayDataChanges = [
      this._roomsService.onRoomsChanged,
    ...
    return merge(...displayDataChanges).pipe(map(() => {
        ...
        let data = this._roomsService.rooms.slice();
