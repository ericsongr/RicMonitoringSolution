...
export class FilesDataSource extends DataSource<any> 
{
    ...
    private _sort: MatSort)
  {
    ...
    this.filteredData = this._rentTransactionsService.rentTransactions;
  ...
  connect(): Observable<any[]>
  {
    const displayDataChanges = [
      this._rentTransactionsService.onRentTransactionsChanged,
    ...
    return merge(...displayDataChanges).pipe(map(() => {
        ...
        let data = this._rentTransactionsService.rentTransactions.slice();
