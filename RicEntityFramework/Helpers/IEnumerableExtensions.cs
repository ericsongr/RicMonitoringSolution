...
namespace RicEntityFramework.Helpers
{
    public static class IEnumerableExtensions
    {
            ...
            string fields)
        {
            ...
            //create a list to ho our ExpandoObjects
            var expandoObjectList = new List<ExpandoObject>();

            //create a list with PropertyInfo objects on TSource. Reflections is 
            //expensive, so rather than doing it for each object in the list, we do
            // it once and reuse the result, After all, part of the reflection is on the
