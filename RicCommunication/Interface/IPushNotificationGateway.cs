...
namespace RicCommunication.Interface
{
    ...
    {
        bool SendNotification(string portalUserId, IEnumerable<string> devicesIds, string title, string message);
        bool SendNotification(IList<string> portalUserIds, IEnumerable<string> devicesIds, string title, string message);
