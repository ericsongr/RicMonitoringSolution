...
const TABLE_FIELDS = "&orderBy=DueDate&field=dueDateString,paidOrUsedDepositDateString,period,paidAmount,balanceDateToBePaid,monthlyRent,previousBalance,currentBalance,totalAmountDue,isDepositUsed,note,transactionType";
